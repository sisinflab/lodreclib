...
public class RFRanker extends Ranker {
	...
	public static float subSamplingRate = 0.5f;//sampling of samples (*WITH* replacement)
	public static float featureSamplingRate = 0.8f;//sampling of features (*WITHOUT* replacement)
	//[b] what to do in each bag
	public static RANKER_TYPE rType = RANKER_TYPE.MART;// RANKER_TYPE.MART;//which algorithm to bag
