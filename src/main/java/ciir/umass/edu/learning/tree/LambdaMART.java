...
public class LambdaMART extends Ranker {
	...
	public static int nThreshold = 256;//256;
	public static int nRoundToStopEarly = 50;//100If no performance gain on the *VALIDATION* data is observed in #rounds, stop the training process right away. 
	public static int nTreeLeaves = 10; //10
