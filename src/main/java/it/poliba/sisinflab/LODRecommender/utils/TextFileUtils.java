...
public class TextFileUtils {
	...
	public static void loadInputURIs(String file, TObjectIntHashMap<String> uri_id, boolean append){
		...
		try{
			...
			if(append){
				if(new File("input_uri_id").exists()){
					...
					BufferedReader br = new BufferedReader(new FileReader("input_uri_id"));
	...
	public static void write(TObjectIntHashMap<String> uri_id, boolean append){
		
		BufferedWriter writer;
		try {
			
			writer = new BufferedWriter(new FileWriter("input_uri_id", append));
