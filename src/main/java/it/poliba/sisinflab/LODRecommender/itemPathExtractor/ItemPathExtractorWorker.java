...
public class ItemPathExtractorWorker implements Runnable {
	...
	public void run(){
		...
		logger.info("item " + main_item_id + ": start paths extraction");
		...
		logger.info("item " + main_item_id + ": paths extraction terminated in [sec]: " 
					+ ((stop - start) / 1000));
	...
	private void start(){
		...
		logger.info("item " + main_item_id + ": paths extraction completed (computed pairs "+count+")");
